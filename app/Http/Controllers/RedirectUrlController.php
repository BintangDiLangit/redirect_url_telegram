...
class RedirectUrlController extends Controller
{
    ...
    {
        try {
            $redirectAds = RedirectUrl::where('type', 'ADS')->latest()->paginate(10);
            return view('admin.redirect-ads', compact('redirectAds'));
        } catch (Exception $e) {
            dd($e->getMessage());
